# this script converts the data for Greece from Johns Hopkins CSSE into a JSON file

import pandas as pd
import json

data_path = "../../all_countries/general/"
...
if __name__ == "__main__":
    ...
    data = data.groupby(["Country/Region", "Date"])[
